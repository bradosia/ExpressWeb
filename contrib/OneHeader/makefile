...
ifeq ($(COMPILER),CLANG)
	...
	LIBRARY_EXE_LINK_FLAGS_STANDARD = -Wl,-Bstatic -stdlib=libc++
	LIBRARY_LINK_LIBS_PATH_STANDARD = 
	LIBRARY_LINK_LIBS_STANDARD = -lstdc++ -lc++ -lm
	PROGRAM_CPP_COMPILE_FLAGS_STANDARD = -O3 -g3 -std=$(PROGRAM_CPP_VERSION) -Wall 
	PROGRAM_CPP_LINK_FLAGS_STANDARD = -Wl,-Bstatic -stdlib=libc++
	PROGRAM_LINK_LIBS_STANDARD = -lstdc++ -lc++ -lm
endif
ifeq ($(COMPILER),MINGW)
	COMPILER_NAME = mingw
	LIBRARY_COMPILE_INCLUDE_PATH_STANDARD = -I"$(LIBRARY_INCLUDE_DIR)"
