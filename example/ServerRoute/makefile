...
# --> default.mk = general include/libraries
# --> --> windows.mk = windows general includes/libraries
# --> --> osx.mk = osx general includes/libraries
# --> --> linux.mk = linux general includes/libraries
# --> makefile.mk = specific includes/libraries

ifndef HOST_OS
	$(error Must specify the variable HOST_OS)
endif
ifndef TARGET_ARCH
	$(error Must specify the variable TARGET_ARCH)
endif
...
ifndef PROJECT_HOME_DIR_PREFIX
	PROJECT_HOME_DIR_PREFIX = .
endif
# Less Frequently Edited Makefile
include $(PROJECT_HOME_DIR_PREFIX)/makefiles/default.mk
...
ifeq ($(LIBRARY_CPP_ONE_HEADER_PARENT_FLAG),1)
	LIBRARY_CPP_ONE_HEADER_COMBINE_DIR = $(PROJECT_HOME_DIR_PREFIX)/$(LIBRARY_ONE_HEADER_COMBINE_DIR)
endif
...
ifeq ($(COMPILER),CLANG)
	COMPILER_NAME = clang
	# LIBRARY COMPILE INCLUDE DIR, LINK LIBRARY DIR, LINK LIBRARY FILE
	LIBRARY_CPP_COMPILE_INCLUDE_DIR_COMPILER_I = 
	LIBRARY_CPP_LINK_LIB_DIR_COMPILER_L = 
	LIBRARY_CPP_LINK_LIB_FILE_COMPILER_l = -lstdc++ -lc++ -lm
	
	LIBRARY_COMPILE_FLAGS_COMPILER = -O3 -g3 -std=$(LIBRARY_CPP_VERSION) -Wall
	LIBRARY_SHARED_LINK_FLAGS_COMPILER = -shared
	
	# PROGRAM COMPILE INCLUDE DIR, LINK LIBRARY DIR, LINK LIBRARY FILE
	PROGRAM_CPP_COMPILE_INCLUDE_DIR_COMPILER_I = 
	PROGRAM_CPP_LINK_LIB_DIR_COMPILER_L = 
	PROGRAM_CPP_LINK_LIB_FILE_COMPILER_l = -lstdc++ -lc++ -lm
	
	PROGRAM_CPP_COMPILE_FLAGS_STANDARD = -O3 -g3 -std=$(PROGRAM_CPP_VERSION) -Wall 
	PROGRAM_CPP_LINK_FLAGS_COMPILER = -stdlib=libc++
endif
ifeq ($(COMPILER),MINGW)
	COMPILER_NAME = mingw
	# LIBRARY COMPILE INCLUDE DIR, LINK LIBRARY DIR, LINK LIBRARY FILE
	LIBRARY_CPP_COMPILE_INCLUDE_DIR_COMPILER_I = 
	LIBRARY_CPP_LINK_LIB_DIR_COMPILER_L = 
	LIBRARY_CPP_LINK_LIB_FILE_COMPILER_l = 
	
	LIBRARY_COMPILE_FLAGS_COMPILER = -O3 -g3 -std=$(LIBRARY_CPP_VERSION) -Wall -fmessage-length=0 
	LIBRARY_SHARED_LINK_FLAGS_COMPILER = -static-libgcc -static-libstdc++ -shared
	
	# PROGRAM COMPILE INCLUDE DIR, LINK LIBRARY DIR, LINK LIBRARY FILE
	PROGRAM_CPP_COMPILE_INCLUDE_DIR_COMPILER_I = 
	PROGRAM_CPP_LINK_LIB_DIR_COMPILER_L = 
	PROGRAM_CPP_LINK_LIB_FILE_COMPILER_l = 
	
	PROGRAM_CPP_COMPILE_FLAGS_STANDARD = -O3 -g3 -std=$(PROGRAM_CPP_VERSION) -Wall -fmessage-length=0 
	PROGRAM_CPP_LINK_FLAGS_COMPILER = -static-libgcc -static-libstdc++ -static
endif
ifeq ($(COMPILER),MSVC)
	COMPILER_NAME = msvc
	# LIBRARY COMPILE INCLUDE DIR, LINK LIBRARY DIR, LINK LIBRARY FILE
	LIBRARY_CPP_COMPILE_INCLUDE_DIR_COMPILER_I = 
	LIBRARY_CPP_LINK_LIB_DIR_COMPILER_L = 
	LIBRARY_CPP_LINK_LIB_FILE_COMPILER_l = -lstdc++
	...
	PROGRAM_CPP_COMPILE_INCLUDE_DIR_COMPILER_I = 
	PROGRAM_CPP_LINK_LIB_DIR_COMPILER_L = 
	PROGRAM_CPP_LINK_LIB_FILE_COMPILER_l = -lstdc++
...
ifeq ($(COMPILER),GCC)
	...
	ifeq ($(TARGET_ARCH),x86)
		...
		LIBRARY_COMPILE_FLAGS_COMPILER = -m32 -O3 -g3 -std=$(LIBRARY_CPP_VERSION) -Wall -fPIC
		LIBRARY_SHARED_LINK_FLAGS_COMPILER = -static-libgcc -static-libstdc++ -shared
	...
	ifeq ($(TARGET_ARCH),x86_64)
		...
		LIBRARY_COMPILE_FLAGS_COMPILER = -O3 -g3 -std=$(LIBRARY_CPP_VERSION) -Wall -fPIC
		LIBRARY_SHARED_LINK_FLAGS_COMPILER = -static-libgcc -static-libstdc++ -shared
...
ifeq ($(LIBRARY_CPP_ONE_HEADER_PARENT_FLAG),1)
	PROGRAM_ONE_HEADER_EXE_FINAL = $(PROJECT_HOME_DIR_PREFIX)/$(PROGRAM_ONE_HEADER_EXE)
endif

# LIBRARY COMPILE INCLUDE DIRECTORY
LIBRARY_CPP_COMPILE_INCLUDE_DIR_I := $(patsubst %, -I"%", $(LIBRARY_CPP_COMPILE_INCLUDE_DIR))
LIBRARY_CPP_COMPILE_INCLUDE_DIR_PROJECT_I := $(patsubst %, -I"$(PROJECT_HOME_DIR_PREFIX)/%", $(LIBRARY_CPP_COMPILE_INCLUDE_DIR_PROJECT))
LIBRARY_CPP_COMPILE_INCLUDE_DIR_VERSION_I := $(patsubst %, -I"%/$(VERSION_NAME)", $(LIBRARY_CPP_COMPILE_INCLUDE_DIR_VERSION))
LIBRARY_CPP_COMPILE_INCLUDE_DIR_PROJECT_VERSION_I := $(patsubst %, -I"$(PROJECT_HOME_DIR_PREFIX)/%/$(VERSION_NAME)", $(LIBRARY_CPP_COMPILE_INCLUDE_DIR_PROJECT_VERSION))
LIBRARY_CPP_COMPILE_INCLUDE_DIR_TARGET_OS_I := $(patsubst %, -I"%", $(LIBRARY_CPP_COMPILE_INCLUDE_DIR_TARGET_OS))
# LIBRARY LINK LIBRARY DIRECTORY
LIBRARY_CPP_LINK_LIB_DIR_L := $(patsubst %, -L"%", $(LIBRARY_CPP_LINK_LIB_DIR))
LIBRARY_CPP_LINK_LIB_DIR_PROJECT_L := $(patsubst %, -L"$(PROJECT_HOME_DIR_PREFIX)/%", $(LIBRARY_CPP_LINK_LIB_DIR_PROJECT))
LIBRARY_CPP_LINK_LIB_DIR_VERSION_L := $(patsubst %, -L"%/$(VERSION_NAME)", $(LIBRARY_CPP_LINK_LIB_DIR_VERSION))
LIBRARY_CPP_LINK_LIB_DIR_PROJECT_VERSION_L := $(patsubst %, -L"$(PROJECT_HOME_DIR_PREFIX)/%/$(VERSION_NAME)", $(LIBRARY_CPP_LINK_LIB_DIR_PROJECT_VERSION))
LIBRARY_CPP_LINK_LIB_DIR_TARGET_OS_L := $(patsubst %, -L"%", $(LIBRARY_CPP_LINK_LIB_DIR_TARGET_OS))
# LIBRARY LINK LIBRARY FILE
LIBRARY_CPP_LINK_LIB_FILE_l := $(patsubst %, -l"%", $(LIBRARY_CPP_LINK_LIB_FILE))
LIBRARY_CPP_LINK_LIB_FILE_VERSION_BOOST_l := $(patsubst %, -l"%$(BOOST_LIBS_POST)", $(LIBRARY_CPP_LINK_LIB_FILE_VERSION_BOOST))
LIBRARY_CPP_LINK_LIB_FILE_TARGET_OS_l := $(patsubst %, -l"%", $(LIBRARY_CPP_LINK_LIB_FILE_TARGET_OS))

# PROGRAM COMPILE INCLUDE DIRECTORY
PROGRAM_CPP_COMPILE_INCLUDE_DIR_I := $(patsubst %, -I"%", $(PROGRAM_CPP_COMPILE_INCLUDE_DIR))
PROGRAM_CPP_COMPILE_INCLUDE_DIR_PROJECT_I := $(patsubst %, -I"$(PROJECT_HOME_DIR_PREFIX)/%", $(PROGRAM_CPP_COMPILE_INCLUDE_DIR_PROJECT))
PROGRAM_CPP_COMPILE_INCLUDE_DIR_VERSION_I := $(patsubst %, -I"%/$(VERSION_NAME)", $(PROGRAM_CPP_COMPILE_INCLUDE_DIR_VERSION))
PROGRAM_CPP_COMPILE_INCLUDE_DIR_PROJECT_VERSION_I := $(patsubst %, -I"$(PROJECT_HOME_DIR_PREFIX)/%/$(VERSION_NAME)", $(PROGRAM_CPP_COMPILE_INCLUDE_DIR_PROJECT_VERSION))
PROGRAM_CPP_COMPILE_INCLUDE_DIR_TARGET_OS_I := $(patsubst %, -I"%", $(PROGRAM_CPP_COMPILE_INCLUDE_DIR_TARGET_OS))
# PROGRAM LINK LIBRARY DIRECTORY
PROGRAM_CPP_LINK_LIB_DIR_L := $(patsubst %, -L"%", $(PROGRAM_CPP_LINK_LIB_DIR))
PROGRAM_CPP_LINK_LIB_DIR_PROJECT_L := $(patsubst %, -L"$(PROJECT_HOME_DIR_PREFIX)/%", $(PROGRAM_CPP_LINK_LIB_DIR_PROJECT))
PROGRAM_CPP_LINK_LIB_DIR_VERSION_L := $(patsubst %, -L"%/$(VERSION_NAME)", $(PROGRAM_CPP_LINK_LIB_DIR_VERSION))
PROGRAM_CPP_LINK_LIB_DIR_PROJECT_VERSION_L := $(patsubst %, -L"$(PROJECT_HOME_DIR_PREFIX)/%/$(VERSION_NAME)", $(PROGRAM_CPP_LINK_LIB_DIR_PROJECT_VERSION))
PROGRAM_CPP_LINK_LIB_DIR_TARGET_OS_L := $(patsubst %, -L"%", $(PROGRAM_CPP_LINK_LIB_DIR_TARGET_OS))
# PROGRAM LINK LIBRARY FILE
PROGRAM_CPP_LINK_LIB_FILE_l := $(patsubst %, -l"%", $(PROGRAM_CPP_LINK_LIB_FILE))
PROGRAM_CPP_LINK_LIB_FILE_VERSION_BOOST_l := $(patsubst %, -l"%$(BOOST_LIBS_POST)", $(PROGRAM_CPP_LINK_LIB_FILE_VERSION_BOOST))
PROGRAM_CPP_LINK_LIB_FILE_TARGET_OS_l := $(patsubst %, -l"%", $(PROGRAM_CPP_LINK_LIB_FILE_TARGET_OS))
...
ifeq ($(TARGET_OS),WIN)
	...
	LIBRARY_CPP_COMPILE_INCLUDE_DIR_ALL = $(LIBRARY_CPP_COMPILE_INCLUDE_DIR_COMPILER_I) $(LIBRARY_CPP_COMPILE_INCLUDE_DIR_TARGET_OS_I) \
		$(LIBRARY_CPP_COMPILE_INCLUDE_DIR_I) $(LIBRARY_CPP_COMPILE_INCLUDE_DIR_PROJECT_I) \
		$(LIBRARY_CPP_COMPILE_INCLUDE_DIR_VERSION_I) $(LIBRARY_CPP_COMPILE_INCLUDE_DIR_PROJECT_VERSION_I)
	LIBRARY_COMPILE_FLAGS = $(LIBRARY_COMPILE_FLAGS_COMPILER)
	
	PROGRAM_CPP_LINK_FLAGS = $(PROGRAM_CPP_LINK_FLAGS_COMPILER)
	PROGRAM_CPP_LINK_LIB_DIR_ALL = $(PROGRAM_CPP_LINK_LIB_DIR_COMPILER_L) $(PROGRAM_CPP_LINK_LIB_DIR_TARGET_OS_L) \
		$(PROGRAM_CPP_LINK_LIB_DIR_L) $(PROGRAM_CPP_LINK_LIB_DIR_PROJECT_L) \
		$(PROGRAM_CPP_LINK_LIB_DIR_VERSION_L) $(PROGRAM_CPP_LINK_LIB_DIR_PROJECT_VERSION_L)
	PROGRAM_CPP_LINK_LIB_FILE_ALL = $(PROGRAM_CPP_LINK_LIB_FILE_COMPILER_l) $(PROGRAM_CPP_LINK_LIB_FILE_l) \
		$(PROGRAM_CPP_LINK_LIB_FILE_VERSION_BOOST_l) $(PROGRAM_CPP_LINK_LIB_FILE_TARGET_OS_l)
	
	LIBRARY_SHARED_LINK_FLAGS = $(LIBRARY_SHARED_LINK_FLAGS_COMPILER) -shared
	LIBRARY_SHARED_LINK_LIB_DIR_ALL = $(LIBRARY_CPP_LINK_LIB_DIR_COMPILER_L) $(LIBRARY_CPP_LINK_LIB_DIR_TARGET_OS_L) \
		$(LIBRARY_CPP_LINK_LIB_DIR_L) $(LIBRARY_CPP_LINK_LIB_DIR_PROJECT_L) \
		$(LIBRARY_CPP_LINK_LIB_DIR_VERSION_L) $(LIBRARY_CPP_LINK_LIB_DIR_PROJECT_VERSION_L)
	LIBRARY_SHARED_LINK_LIB_FILE_ALL = $(LIBRARY_CPP_LINK_LIB_FILE_COMPILER_l) $(LIBRARY_CPP_LINK_LIB_FILE_l) \
		$(LIBRARY_CPP_LINK_LIB_FILE_VERSION_BOOST_l) $(LIBRARY_CPP_LINK_LIB_FILE_TARGET_OS_l)
		
	LIBRARY_STATIC_LINK_FLAGS = 
	# OneHeader c++
	PROGRAM_ONE_HEADER_COMPILE_FLAGS = $(PROGRAM_CPP_COMPILE_FLAGS_STANDARD)
	PROGRAM_ONE_HEADER_LINK_FLAGS = $(PROGRAM_CPP_LINK_FLAGS_COMPILER)
endif
ifeq ($(TARGET_OS),android)
	# cpp library commands and flags
	LIBRARY_CPP_COMPILE_INCLUDE_DIR_ALL = $(LIBRARY_CPP_COMPILE_INCLUDE_DIR_COMPILER_I) $(LIBRARY_CPP_COMPILE_INCLUDE_DIR_TARGET_OS_I) \
	...
	PROGRAM_CPP_LINK_FLAGS = $(PROGRAM_CPP_LINK_FLAGS_COMPILER) --sysroot="$(NDK_SYSROOT_PATH)"
	PROGRAM_CPP_LINK_LIB_DIR_ALL = $(PROGRAM_CPP_LINK_LIB_DIR_COMPILER_L) $(PROGRAM_CPP_LINK_LIB_DIR_TARGET_OS_L) \
		$(PROGRAM_CPP_LINK_LIB_DIR_L) $(PROGRAM_CPP_LINK_LIB_DIR_PROJECT_L) \
		$(PROGRAM_CPP_LINK_LIB_DIR_VERSION_L) $(PROGRAM_CPP_LINK_LIB_DIR_PROJECT_VERSION_L)
	PROGRAM_CPP_LINK_LIB_FILE_ALL = $(PROGRAM_CPP_LINK_LIB_FILE_COMPILER_l) $(PROGRAM_CPP_LINK_LIB_FILE_l) \
	...
	PROGRAM_ONE_HEADER_LINK_FLAGS = $(PROGRAM_CPP_LINK_FLAGS_COMPILER) --sysroot="$(NDK_SYSROOT_PATH)"
endif
ifeq ($(TARGET_OS),LINUX)
	# cpp library commands and flags
	LIBRARY_CPP_COMPILE_INCLUDE_DIR_ALL = $(LIBRARY_CPP_COMPILE_INCLUDE_DIR_COMPILER_I) $(LIBRARY_CPP_COMPILE_INCLUDE_DIR_TARGET_OS_I) \
	...
	PROGRAM_CPP_LINK_FLAGS = $(PROGRAM_CPP_LINK_FLAGS_COMPILER) -pthread
	PROGRAM_CPP_LINK_LIB_DIR_ALL = $(PROGRAM_CPP_LINK_LIB_DIR_COMPILER_L) $(PROGRAM_CPP_LINK_LIB_DIR_TARGET_OS_L) \
		$(PROGRAM_CPP_LINK_LIB_DIR_L) $(PROGRAM_CPP_LINK_LIB_DIR_PROJECT_L) \
		$(PROGRAM_CPP_LINK_LIB_DIR_VERSION_L) $(PROGRAM_CPP_LINK_LIB_DIR_PROJECT_VERSION_L)
	PROGRAM_CPP_LINK_LIB_FILE_ALL = $(PROGRAM_CPP_LINK_LIB_FILE_COMPILER_l) $(PROGRAM_CPP_LINK_LIB_FILE_l) \
	...
	# OneHeader c++
	PROGRAM_ONE_HEADER_COMPILE_FLAGS = $(PROGRAM_CPP_COMPILE_FLAGS_STANDARD)
	PROGRAM_ONE_HEADER_LINK_FLAGS = $(PROGRAM_CPP_LINK_FLAGS_COMPILER) -pthread
endif
ifeq ($(TARGET_OS),OSX)
	# cpp library commands and flags
	LIBRARY_CPP_COMPILE_INCLUDE_DIR_ALL = $(LIBRARY_CPP_COMPILE_INCLUDE_DIR_COMPILER_I) $(LIBRARY_CPP_COMPILE_INCLUDE_DIR_TARGET_OS_I) \
		$(LIBRARY_CPP_COMPILE_INCLUDE_DIR_I) $(LIBRARY_CPP_COMPILE_INCLUDE_DIR_PROJECT_I) \
		$(LIBRARY_CPP_COMPILE_INCLUDE_DIR_VERSION_I) $(LIBRARY_CPP_COMPILE_INCLUDE_DIR_PROJECT_VERSION_I)
	LIBRARY_COMPILE_FLAGS = $(LIBRARY_COMPILE_FLAGS_COMPILER) -mmacosx-version-min=10.9 
	...
	LIBRARY_SHARED_LINK_FLAGS = $(LIBRARY_SHARED_LINK_FLAGS_COMPILER) -shared -dynamiclib -current_version 1.0 -compatibility_version 1.0
	LIBRARY_SHARED_LINK_LIB_DIR_ALL = $(LIBRARY_CPP_LINK_LIB_DIR_COMPILER_L) $(LIBRARY_CPP_LINK_LIB_DIR_TARGET_OS_L) \
		$(LIBRARY_CPP_LINK_LIB_DIR_L) $(LIBRARY_CPP_LINK_LIB_DIR_PROJECT_L) \
		$(LIBRARY_CPP_LINK_LIB_DIR_VERSION_L) $(LIBRARY_CPP_LINK_LIB_DIR_PROJECT_VERSION_L)
	LIBRARY_SHARED_LINK_LIB_FILE_ALL = $(LIBRARY_CPP_LINK_LIB_FILE_COMPILER_l) $(LIBRARY_CPP_LINK_LIB_FILE_l) \
...
LIBRARY_CPP_EXE_BIN: $(LIBRARY_OBJ_FILES)
	$(GCC) $(PROGRAM_CPP_LINK_FLAGS) $(PROGRAM_CPP_LINK_LIB_DIR_ALL) -o $(LIBRARY_CPP_EXE_BIN) $^ $(PROGRAM_CPP_LINK_LIB_FILE_ALL)

LIBRARY_CPP_SHARED_BIN: $(LIBRARY_OBJ_FILES)
	$(GCC) $(LIBRARY_SHARED_LINK_FLAGS) $(LIBRARY_SHARED_LINK_LIB_DIR_ALL) -o $(LIBRARY_CPP_SHARED_BIN) $^ $(LIBRARY_SHARED_LINK_LIB_FILE_ALL)
...
$(LIBRARY_OBJ_DIR)/%.o: $(LIBRARY_SRC_DIR)/%.cpp
	$(GCC) $(LIBRARY_COMPILE_FLAGS) $(LIBRARY_CPP_COMPILE_INCLUDE_DIR_ALL) -c -o $@ $<
