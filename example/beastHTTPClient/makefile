...
PROGRAM_ONE_HEADER_EXE = $(PROGRAM_ONE_HEADER_BIN_VERSION)/$(PROGRAM_ONE_HEADER_NAME).exe
...
ifeq ($(TARGET_OS),WIN)
	...
	LIBRARY_EXE_LINK_LIB_PATH = $(LIBRARY_LINK_LIBS_STANDARD) $(LIBRARY_CPP_LINK_LIB_PATHS_L) $(LIBRARY_CPP_LINK_LIB_PATHS_VERSION_L) \
		-L"$(BOOST_LIBS_DIR)"
